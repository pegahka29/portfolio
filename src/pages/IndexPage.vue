<template>
    ...
    <div class="text-center q-mt-sm">
      <q-btn v-for="socialItem in SocialMediaItems" :key="socialItem.name"
        ...
        <q-tooltip v-if="socialItem.hover" class="text-section text-body2" :offset="[10, 10]" :class="$q.dark.isActive ? 'bg-dark text-white' :'bg-white text-dark'">
          {{ socialItem.hover }}
        </q-tooltip>
      </q-btn>
    </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const SocialMediaItems = [
      ...
      {
        name: 'Linkedin',
        link: 'https://www.linkedin.com/in/pegaahk',
        icon: 'mdi-linkedin',
        target: '_blank',
        hover: 'pegaahk'
      },
      {
        name: 'Skype',
        link: 'https://join.skype.com/invite/c5ybyrqlD1td',
        icon: 'mdi-skype',
        target: '_blank',
      },
      {
        name: 'Github',
        link: 'https://github.com/pegahka29',
        icon: 'mdi-github',
        target: '_blank',
        hover: 'pegahka29',
      },
